...
class MiFitnessHealthPlugin(
    ...
    async def initialize(self) -> None:
        """Delegate startup while keeping AstrBot's lifecycle entrypoint local."""
        await RuntimeCoordinationMixin.initialize(self)

    async def terminate(self) -> None:
        """Delegate shutdown from the concrete plugin class AstrBot inspects."""
        await RuntimeCoordinationMixin.terminate(self)
